...
outro5 = "[func:DUB,death1/4][noskip][func:Final_4][w:6][speed:0.75]Rei'ye söz verdim,[w:8] \nsonuna kadar onunla\nolacağıma dair[waitall:5]..."
outro6 = "[func:DUB,death1/5][noskip][w:9][speed:0.75]Ve,[w:9] biliyorsun[waitall:3]...[speed:0.75][w:5] \n[func:Final_6]Sözümü tuttum.[w:23] \nİyi bir ablaydım."
outro7 = "[func:DUB,death1/6][noskip][func:Final_4][w:5][speed:0.75]Düşüşümden beri,[w:8] \nölmeyi diledim.[w:14][speed:1] \nBu günleri[w:3] unutmayı[w:2][speed:1] \ndiledim[w:1]..."
outro8 = "[func:DUB,death1/7][noskip][w:7]Ve şimdi,[w:13] sonumla \nyüzleşiyorum[waitall:5]...[w:10][waitall:2] [func:head4]\nçok pişmanım."
outro9 = "[func:DUB,death1/8][noskip][w:11][speed:1]Akrabalarımı korumak \niçin hiçbir şey \nyapmadığıma çok pişmanım."
...
outro14 = "[func:DUB,death1/12][noskip][w:10]Haklıydım.[w:23] \nKurtarıcımız değilsin."
outro15 = "[func:DUB,death1/13][noskip][w:9][speed:0.75]Sen[waitall:5]...[waitall:1]\n[func:Final_creepy][color:ff0000]PİS BİR \nKARDEŞ KATİLİSİN."
...
outro18 = "[func:DUB,death1/16][func:QuietMusic][noskip][waitall:2][func:Final_7][w:9]Yakında[waitall:5]...[waitall:2][w:10] Yakında[waitall:5]...[waitall:4] \nGörüşeceğiz[waitall:5]...[func:dead][w:60][func:WON][next] "
...
function WriteLine(num,ingo)
	...
	SavioWrite.ReplaceLine(num,ingo) --Ga+-me--+Hu-*nt<>ers   Ç-+evi++-ri99-ek-*ibi
end
function GetFiles()
...
function FullIntro()
	...
	if globalstage=="5" then
		if lang=="rus" then
			...
			elseif lang=="eng" then
			dial={"[noskip][func:face,yes][next] ","[func:DUB,prolog/1][effect:twitch,1][font:overworld][color:ffffff][func:Peachy]*[waitall:2][w:10]Yani, [waitall:1][w:10]buradayız[w:3].", "[func:DUB,prolog/2][func:normal]*Tekrar hoş geldin, ortak.","[func:Peachy]*[waitall:5]...", "[func:DUB,prolog/3][w:3][speed:1.5]*Neredeyse gö[w:1]re[w:1]vini \n[speed:1]tamamladın,[w:12] değil [func:JUMP]mi [func:face,no][func:Vietnam][w:60]"}
		end
		else
		if lang=="rus" then
			if dubbing==true then
			...
			elseif lang=="eng" then
			dial={"[noskip][func:face,yes][next] ","[func:DUB,prolog/1][effect:twitch,1][font:overworld][color:ffffff][func:Peachy][func:checkquick]*[waitall:2][w:10]Yani, [waitall:1][w:10]buradayız[w:3].", "[func:DUB,prolog/2][func:normal]*Tekrar hoş geldin, \nortak.","[func:Peachy]*[waitall:5]...", "[func:DUB,prolog/3][w:3][speed:1.5]*Neredeyse [w:1]görevini \n[speed:1]tamamladın,[w:12] değil mi?[func:normal]", "[func:Interruption][w:1][func:DUB,prolog/4][func:normal1]*[w:2]Sadece emin olmak istedim.", "[func:Peachy]*[waitall:6]...", "[func:DUB,prolog/5]*Bir şey sormama izin ver[w:5].", "[func:DUB,prolog/6][func:normal]*[w:2]Kendinin[w:2],[w:5] sonuçlardan \nüstün olduğunu mu \n[speed:1,5]düşünüyorsun[w:4]?","[func:DUB,prolog/7][func:Peachy]*[w:3]Tüm [w:1]o yaptıklarının[waitall:3]...[w:30][func:ph1][func:face,no][next] "}
		end
	end
...
function EnteringState(newstate, oldstate)
	...
	if GetGlobal("charaisdead") == 8 and wons==0 then
		...
		if lang=="rus" then
			...
			enemies[1].SetVar("currentdialogue", {"[func:NoMercy1]Evet,[w:3] aynen[w:3].[w:4].[w:4].[w:4]","[func:head]Bir B plânım vardı.[w:6]","[func:NoMercy1]Bundan hayatta \nkalmak için küçük [func:Think]bir \nşansın vardı.[w:6]","[func:NoMercy1]Daha kötü şeylerde \nhayatta kaldın,[w:3] [func:head]\ndeğil mi?","Ve[w:3].[w:4].[w:4].[w:4] [func:NoMercy1]\nİşte bu.[w:6] B plânım.[w:6]","Ben[w:3].[w:4].[w:4].[w:4] \nBana saldırmana \nizin vermeyeceğim.[w:6]","Ve[w:3].[w:4].[w:4].[w:4] \nİkimiz de \nöleceğiz.[w:6]","[func:Final_7]Ve bu döngü bitecek.[w:6] \nEğer bunu \nkurtaramayacak yada \nsona erdiremeyecek \nisem,[w:3] bunu cehennemde \nyakmayı tercih ederim.[w:6]","Ve şimdi[w:3].[w:4].[w:4].[w:4] [func:head]\nGörüşürüz.[w:6] \nKendine iyi bak[w:3].[w:4].[w:4].[w:4]","[func:sleepy][next] "})
		end
		State("ENEMYDIALOGUE")
	end
...
if ToHappyEnd>0 then
	...
	if t==1 then
		...
		if lang=="rus" then
			...
			dial={"Chara elini tuttu ve ikiniz de koridordan çıktınız.","Bu kısa zamanda bile sana bir çok şey anlattı.","Korkularını,[w:3] savaştaki acılarını,[w:3] Yapay Azmin verdiği hissi.[w:6]","Ve seni kaybetme korkusu.[w:6]","Buna bir cevap veremezdin.[w:6]","Aynı zamanda,[w:3] üzerinde bu kadar ilgi olmasına pek alışkın değildin.[w:6]","Metta'nınkinden farklı olarak, tek başınaydın. Ve pek özgüveninde yoktu[w:6]","İlgi her zaman seni düşündürdü.[w:6]","Belki de[waitall:4][w:3]...[waitall:1][w:3] Metta Boogie ile pek çok ortak özelliğinin olması konusunda haklıydı[waitall:4][w:3]...[waitall:1][w:3]","[waitall:4][w:3]...[waitall:1][w:3]","[func:HappyCharaMeal11][color:000000]"}
		end
		for i=1,#dial do
	...
	if t==1 then
		...
		if globalstage=="5" then
			...
			if lang=="rus" then
				...
				dial={"[func:face,yes][func:SetFaceLost,shocked]Ben[waitall:4][w:3]...[waitall:1][w:3] \nÇoktan[waitall:4][w:3]...[waitall:1][w:3]","[func:SetFaceLost,shocked2]Bu olmamalıydı[waitall:4][w:3]...[waitall:1][w:3]","[func:SetFaceLost,shocked]Gerçekten öldüysem[waitall:4][w:3]...[waitall:1][w:3]","[func:SetFaceLost,base_close][waitall:4][w:3]...[waitall:1][w:3]","[func:SetFaceLost,base]Denemenin anlamı \nyok, değil mi?","[func:SetFaceLost,base_left]Seni yeni güçlerim ile \ndurdurmalıydım,[w:3] fakat beni \nçoktan öldürdüysen[waitall:4][w:3]...[waitall:1][w:3]","[func:SetFaceLost,sobbing_close]Neden[waitall:4][w:3]...[waitall:1][w:3] [func:SetFaceLost,sobbing_thinking]\nNeden umurumda olsunki?","[func:fightbegin][func:face,no][next] "}
			end
...
if MettaLost==false then
	...
	if t==240 then
		...
		if lang=="rus" then
			...
			dial={"[func:LostMettaFace,Bored]Senaryomu nasıl oynayacağına sen mi karar veriyorsun?[w:6]","[func:LostMettaFace,Thought]Cidden karakter dışı oynamak iyi bir fikir mi?[w:6]","[func:LostMettaFace,Afraid]Cidden kız arkadaşına nazik davranacağımı mı sandın?[w:6]","[func:LostMettaFace,saw][func:LostMettaAngry][waitall:4]LANET OLSUN,[w:3] A K T Ö R","[func:LostMettaCalm][func:LostMettaFace,punishment]Sevgi ve dostluk hakkındaki konuşlmalarından nefret ediyorum[waitall:4][w:3]...[waitall:1][w:3]","[func:LostMettaFace,Afraid]Sanki ikisi dünyayı kurtaracak.","[func:LostMettaFace,Dispice]İğrenç.[w:6][func:LostMettaFace,Afraid]\nBir şey öğrenmemişsin.[w:6][func:LostMettaFace,punishment]\nUğraşmamışsın bile.[w:6]","Blloky gibisin, acınası.[w:6]","Kendini bir tanrı gibi mi hissettin?[w:6]","[func:LostMettaFace,Afraid]Bu vücudu seninmiş gibi kullancağını mı?[w:6]","Sanırım bir şey unuttun[waitall:4][w:3]...[waitall:1][w:3]","[waitall:4][func:LostMettaFace,screamer][func:LostMettaAngry]BU[w:4] VÜCUDU[w:4] UZUN[w:4] ZAMAN[w:4] ÖNCE [w:4]BANA [w:4]VERDİN [w:4]","[func:LostMettaCalm][func:LostMettaFace,Afraid]Ve şimdi[waitall:4][w:3]...[waitall:1][w:3]","[func:LostMettaFace,punishment]Sözleşmen sona erdi.[w:6] \nVe sözleşmesi biten aktörlere nolur?[w:6]","[func:LostMettaFace,saw]Kovulurlar [waitall:4][func:LostMettaAngry]","[func:LostMettaCalm][func:LostMettaFace,Afraid][waitall:4][w:3]...[waitall:1][w:3]Seninle vakit geçirmek güzeldi.[w:6]","Fakat bu beden daha iyi bir yıldız hak ediyor.[w:6]","[func:LostMettaFace,Thought]Bu vücut beni hakediyor.[w:6]","[func:LostMettaFace,Afraid]Ve sen?[w:6]","[func:LostMettaFace,Dispice]Burada çürüyeceksin[waitall:4][w:3]...[waitall:1][w:3]","Uzun bir zaman[waitall:4][w:3]...[waitall:1][w:3] [func:LostMettaFace,saw]\nSonsuza [waitall:4]\nk a d a r[waitall:4][w:3]...[waitall:1][w:3][w:90][func:Quiting][w:1800]"}
		end
		globalstage="7"
		WriteSavio()
		for i=1,#dial do
...
if Titr2.phase>0 then
	...
	if Titr2.phase==1 then
		...
		if s==0 and t>1000 then
			...
			if lang=="eng" then
				s="Chara![w:6] \nYeraltındaki en iyi reytinglerime bulaşma!"
			end
			...
			local n="GeorgTime"
			local s="Karakter dokuları\n(Kaşlarıyla nefret edenlere karşı savaşıyor)"
			if lang=="rus" then
			...
			local n="wonderless."
			local s="Besteci(Müzik güncellemenin olayı ne?)"
			if lang=="rus" then
			...
			if lang=="eng" then
				s="T-Tori[waitall:4][w:3]...[waitall:1][w:3] \nBeni affedecek misin?"
			end
			...
			if lang=="eng" then
				s="Dreemurr[waitall:4][w:3]...[waitall:1][w:3] \nEh[waitall:4][w:3]...[waitall:1][w:3] \nTam bir ahmaksın[waitall:4][w:3]...[waitall:1][w:3]"
			end
			...
			if s==27 and t>6030 then
				Titr2.step=28
				local l="DarkSd"
				local n="GHÇE'ye destek olduğu için"
				if lang=="rus" then
					n="За вишневые видео"
				end
			...
			local n="MitMar"
			local s="Promosyon Sanatçısı\n(bir peynirde yaşamak için sebepler buluyor!)"
			if lang=="rus" then
				s="Промо-художник\nМыш (кродетця)"
			end
			...
			local T={}
			local name="Miray Özdönmez\n"
			local dial=""
			if lang=="rus" then
				dial=dial.."Английский голос Чары"
				else
				dial=dial.."Türkçe Chara Seslendirmeni"
			end
			...
			if lang=="rus" then
				...
				dial=dial.."Rusça Chara Seslendirmeni"
			end
			...
			if T<-1000 then
				...
				if T>900 then
					...
					if lang=="rus" then
						...
						dial={"[font:overworld]Aslında,[w:6] fotoğrafımın çekilmesini sevmem.[w:12] \nFakat bu favorim olacak.[w:12] \nNe düşünüyorsun[waitall:4][w:3]...[waitall:1][w:12] Arkadaşım?[w:30][func:AllGoesDarkOnceMore]"}
					end
...
if Titr1.phase>0 then
	...
	if Titr1.phase==1 then
		...
		if t>0 and Titr1.step==1 then
			...
			if wons==0 then
				...
				if lang=="rus" then
					...
					string={"[func:Dub,buggy/5/1][func:BoogyLook,sad]Beni çıkarman için[w:2] sana yalvardım,[w:5] değil mi?[w:6] ","[func:Dub,buggy/5/2][func:BoogyLook,sarcastic]Ama öyle görünüyor ki[w:3] bana ihtiyacın var[waitall:4][w:3]...[w:15]","[func:Dub,buggy/5/3][func:BoogyLook,joking]Cidden mi,[w:1] kuzen?[w:6] ","[func:Titr1NextPhase][next] "}
				end
			end
			if dubbing==true then
				for i=1,#string do
		...
		if t<180 then
			...
			if wons==0 then
				if lang=="rus" then
					...
					string={"[func:Dub,buggy/2/1][func:BoogyLook,dissapointed]Dramalara hastaydın.[w:10] Onlara epey hevesliydin,[w:7] neredeyse kaderin gibiydiler.","[func:Dub,buggy/2/2][func:BoogyLook,closedeyes]Fakat beni drama için öldürmen \naklıma gelince[waitall:4][w:3]...[speed:0.75][w:3]","[func:Dub,buggy/2/3][func:BoogyLook,base]Artık[w:3] seni tatmin etmek için bir neden göremiyorum.","[func:Titr1NextPhase][next] "}
		...
		if t<180 then
			...
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,250)
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("Спрайт оверворлда и меню битвы","Ana dünya dokuları",b),{0,0},480,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,220)
			n=n+1
			...
			if wons==0 then
				if lang=="rus" then
					...
					string={"[func:Dub,buggy/3/1][func:BoogyLook,base]Aptal değilim, Metta[waitall:4][w:3]...[speed:0.75][w:3]","[func:Dub,buggy/3/2][func:BoogyLook,uncertain]Hayattan vazgeçtim,[w:5] dünyanın kaderi umurumda değil.","[func:Dub,buggy/3/3][func:BoogyLook,joking]Bir ruhum yok.[w:10] \nO hisleri hissedemiyorum.","[func:Dub,buggy/3/4][func:BoogyLook,base]Sanatsal egonu yok etmek istemiyorum.[w:5] ","[func:Titr1NextPhase][next] "}
				end
				else
				if lang=="rus" then
					...
					string={"[func:Dub,buggy/7/1][func:BoogyLook,uncertain]Demek istediğim,[w:10] ayağının altındaki yeri korumak için her köşeye tutunuyorsun...[w:3] ","[func:Dub,buggy/7/2][func:BoogyLook,down]O vadide beni onlardan korumak için bir kutu [speed:2]kullanmıştın[speed:1][waitall:4][w:6]...[w:15]","[func:BoogyLook,closedeyes][func:Dub,buggy/7/3]Heh,[w:6] işte o kutu elindeki en iyi şeydi.[w:3] ","[func:Titr1NextPhase][next] "}
				end
			end
			if dubbing==true then
				for i=1,#string do
		...
		if t<180 then
			...
			n=1
			Titr1.Titrs={}
			Titr1.Titrs[n]=CreateText(ForTitr1("Miray Özdönmez","Miray Özdönmez"),{0,0},480,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,390)
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("Английский голос Чары","Türkçe Chara Seslendirmeni",b),{0,0},480,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,360)
			n=n+1
			...
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,300)
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("Русский голос Чары","Rusça Chara Seslendirmeni",b),{0,0},480,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,270)
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("Semih Aşıkoğlu.","Semih Aşıkoğlu."),{0,0},480,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,210)
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("Всеединый голос Буги","Türkçe Boogy Seslendirmeni",b),{0,0},480,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth()/2,180)
			n=n+1
			...
			if wons==0 then
				if lang=="rus" then
					...
					string={"[func:Dub,buggy/4/1][func:BoogyLook,closedeyes]Bu yüzden[waitall:4][w:3]...[speed:0.75][w:6] [func:BoogyLook,cocky]\nBeni senaryolarından çıkar.","[func:Dub,buggy/4/2]Sana göre yaşamak istemiyorum.","[func:Dub,buggy/4/3][func:BoogyLook,base]Ailemin yerini alan şeytanla[w:3] oynamak istemiyorum.","[func:Dub,buggy/4/4]Artık kuzenim değilsin.[w:15] [speed:0.5][novoice][voice:lowbuggy][func:BoogyLook,death]\nVe[w:1] bu yüzden artık hayatım umurumda değil.","[func:Titr1NextPhase][next] "}
				end
				else
				if lang=="rus" then
					...
					string={"[func:Dub,buggy/8/1][func:BoogyLook,base]Neyse ya boşver[waitall:4][w:3]...[speed:0.75][w:9] [func:BoogyLook,uncertain]Sadece ölmeden önce eskileri hatırlamak istedim.[w:6] ","[func:Dub,buggy/8/2][func:BoogyLook,confused]Ama bunu biraz düşün,[w:12] sende o kutu gibisin, değil mi?[w:10] [func:BoogyLook,closedeyes]Biliyorsun[waitall:4][w:6]...[speed:0.75][w:9]","[func:Dub,buggy/8/3][func:BoogyLook,joking]Bu dünyanın nasıl çalıştığını ve...[w:10][w:12] \n...kimin kuklaları oynattığını.[w:9] ","[func:Dub,buggy/8/4][func:BoogyLook,dissapointed]Bunu biraz düşün.[w:18] [func:BoogyLook,closedeyes]Bunu tartışabilirdik[waitall:4][w:6]...[speed:0.75][w:9][novoice][voice:lowbuggy][func:BoogyLook,death][speed:0.5] \nBir daha ki buluşmamızda~[w:12]","[func:Titr1NextPhase][next] "}
				end
			end
			if dubbing==true then
				for i=1,#string do
		...
		if t>0 and Titr1.step==0 then
			...
			Titr1.Titrs[n].progressmode="none"
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("За создание INSANTION","Dokular, \nChara diyalogları, Ana dosya"),{120,285},640,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("keno9988i","Yesil_51#5151",a),{120,225},640,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			n=n+1
			...
			Titr1.Titrs[n].progressmode="none"
			n=n+1
			Titr1.Titrs[n]=CreateText(ForTitr1("Avranik","Sonery#0001",a),{120,135},640,"Top",-1)
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			n=n+1
			...
			Titr1.Titrs[n].HideBubble()
			Titr1.Titrs[n].progressmode="none"
			Titr1.Titrs[n].MoveTo(320-Titr1.Titrs[n].GetTextWidth(),300) --Ga+-me-+Hu-*nt<>ers   Ç-+evi++-ri99-ek-*ibi
			n=n+1 
	...
	if Input.Confirm==1 and (fPlayer2.absx==100 or fPlayer2.absx==400) then
		...
		if fPlayer2.absx>320 then
			if lang=="rus" then
				...
				dial={"[noskip][func:face,yes][next] ","[func:DUB,prolog/1][effect:twitch,1][font:overworld][color:ffffff][func:DUB,prolog/4][func:normal1]*[w:2]Sadece [w:15]emin [w:1]olmak[w:1] istedim[w:1].", "[func:Peachy]*[waitall:6]...", "[func:DUB,prolog/5]*Bir şey[w:10] sormama [w:3]izin ver[w:5].", "[func:DUB,prolog/6][func:normal]*[w:2]Kendinin[w:2],[w:5] sonuçlardan [speed:1.5]\nüstün [w:2][speed:1]olduğunu mu \ndüşünüyorsun?","[func:DUB,prolog/7][func:Peachy]*[w:3]Tüm [w:1]o yaptıklarının[waitall:3]...","[func:DUB,prolog/8][func:normal][noskip]*Cezasız kalacağını mı?[w:30][func:ph1][func:face,no][next] "}
			end
		...
		if choicer==2 then
			...
			if HaveKilledChara==false then
				if lang=="rus" then
					...
					dial={"Mükemmel[waitall:4][w:3]...","[func:MTT,calm]Sana her zaman inandım.","Sonsuza kadar beraber olacağız,[w:6] değil mi?[w:9] [func:MTT,okey]O zavallı gibi bana ihanet edecek misin?","Ben[waitall:4][w:3]...[waitall:2][w:3] [func:MTT,calm]Çok mutluyum.[w:9] \n[func:MTT,proposal]Benimle gel.","Burada[waitall:4][w:3]...[waitall:2][w:3] [color:ff20a0]Her şey [func:EVERYTHINGEVERYWHERE][w:6]her yerde.[w:180]"}
				end
				else
				if lang=="rus" then
			...
			if time==31 then
				...
				if enemies[1].GetVar("LostChildHopes")==false then
					...
					if lang=="rus" then
						...
						dial={"[func:LostKidFace,shocked,+]N-Ne?-", "[func:LostKidFace,shocked2,+][func:SAVEMUSIC]İstemesemde \nkaçındım,[w:3] fakat[waitall:4][w:3]...", "[func:LostKidFace,shocked3,+]Fakat[waitall:4][w:3]...[waitall:1][w:3] \nBenim yerime \nrefleksimdi o[waitall:4][w:3]...", "[func:LostKidFace,base_close,-]Nedense[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,gloomy,+]\nŞu an korkuyu \niliklerimde \nhissediyorum[waitall:4][w:3]...", "[func:LostKidFace,base_left,+]Atağını görmedim \nbile[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,confused,+]\nO da neydi?", "[func:LostKidFace,base_close,-][waitall:4][w:3]...", "[func:LostKidFace,hope_base,+]Sanırım[waitall:4][w:3]...[waitall:1][w:3] \nAnladım.", "[func:LostKidFace,hope_cheers,+]Kuklacı oyuna \nkatıldı.[w:6] \nVe beni kullanmaya \nçalışıyor.", "[func:LostKidFace,hope_close,-]Ortak[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,hope_determined,+]\nHenüz pes edemezsin!", "[func:LostKidFace,hope_question,+]Eğer hala oradaysan \nve beni öldürmek \nistemiyorsan[waitall:4][w:3]...", "[func:LostKidFace,hope_smile,+]Sanırım sana ikinci \nbir şans verebilirim.", "[func:LostKidFace,hope_cheers,+]Beraber onu \nyeneceğiz.[w:6] \nSadece kontrolü \nkaybetme!","[func:LostKidFace,hope_base,+][next] "}
					end
					for i=1,#dial do
					...
					if lang=="rus" then
						...
						dials={{"Ah[waitall:4][w:3]...[waitall:1][w:3] ","Ben[waitall:4][w:3]...[waitall:1][w:3] \nBen iyiyim, ortak[waitall:4][w:3]...[waitall:1][w:3] \nEndişelenme"},{"Bu[waitall:4][w:3]...[waitall:1][w:3]","Bu çok kötüydü[waitall:4][w:3]...[waitall:1][w:3] \nHassiktir[waitall:4][w:3]...[waitall:1][w:3] \nAh."},{"Ha[waitall:4][w:3]...[waitall:1][w:3] \nHa[waitall:4][w:3]...[waitall:1][w:3]","Nefes al[waitall:4][w:3]...[waitall:1][w:3] \nSakince[waitall:4][w:3]...[waitall:1][w:3]","Off."},{"Bu acı bir hiç, \nciddiyim[waitall:4][w:3]...[waitall:1][w:3]","Fakat, ah, bu \nbirazcık acıtıyor[waitall:4][w:3]...[waitall:1][w:3]"}}
					end
	...
	if not introtimer then
		...
		if introtimer==80 then
			...
			if lang=="rus" then
				...
				elseif lang=="eng" then
				dial={"[next] ","[func:face,yes][font:overworld][effect:twitch,1][func:NoMercy1][color:ffffff]*[waitall:5]...[w:8][waitall:2][func:DUB,prolog/9]Görüyorum.", "[func:DUB,prolog/10][effect:twitch,1]*Heh[waitall:5]...[waitall:1][w:5]\n[func:Danger]Bu bir şekilde [w:2]komik[w:4].", "[func:NoMercy1][waitall:5]...","[func:DUB,prolog/11]*[w:5]Sana terbiye kurallarını \nöğreterek [w:4]kendimi \n[speed:1.5]yormayacağım.","[func:DUB,prolog/12][noskip]*[w:1]Sonuçta, [w:12]zaten \nonları biliyorsun[waitall:5]...[waitall:1]\n[w:14][func:Danger1]Değil mi? =)[w:50][func:ph2][func:face,no][next] "}
			end
	...
	if introtimer==true then
		...
		if introtimer==80 then
			...
			if lang=="rus" then
				...
				elseif lang=="eng" then
				dial={"[func:face,yes][next] ","[func:DUB,prolog/13][effect:twitch,1][font:overworld][color:ffffff][func:NoMercy1][w:9][waitall:2]*hüff*","[func:NoMercy1]*[func:DUB,prolog/14][w:9]Hiçbir şey sonsuza kadar \nsürmez[w:2].","[func:DUB,prolog/15]*Ve dünyamın kaderi \ntoz olmaksa[waitall:5]...","[func:DUB,prolog/16][func:NoMercy1]*[w:3]En azından [color:ff0000]SENİ[color:ffffff] \ntoz etmeyi deneyeceğim[waitall:1][w:14].","[func:fightbegin][func:face,no][next] ","[func:fightbegin][func:face,no][next] "}
			end
			dial=EveryDial(dial,"[noskip][font:overworld][effect:twitch,1][color:ffffff]","[novoice]")
			enemies[5].SetVar("currentdialogue",dial)
			SetGlobal("phase1",0)
	...
	if slashtime>8999 or misstime>139 then
		...
		if misstime==140 and wons==1 and enemies[1].GetVar("LostGotMissed")==false then
			...
			if lang=="rus" then
				...
				enemies[1].SetVar("currentdialogue",{"[effect:none][waitall:4][w:3]...[waitall:1][w:3]Bu, anlamadığım bir şaka filan mı?","[next] "})
			end
...
function Chainsaw(ingo,newdamage)
	...
	for i=1,amm do
		...
		num=math.floor(num/10) ---+-Ga++-me--+Hu-*nt<>ers   Ç-+evi+-+-ri99-+ek--*ibi
	end
end
	...
	if prog==26 and wons==0  then
		...
		if mercy==1 then
			...
			if lang=="rus" then
				...
				comm="[speed:0.75][color:8040ff]Sakın cürret etme tatlım..."
				t={"[func:head4]Git[waitall:4][w:3]...","Ciddiyim,[w:3] [func:Look]git artık.[w:6] [func:sad]\nÇoktan yoruldum bile.","[func:head4]Cidden [speed:0.[w:6]75][w:3]bir şeyi[speed:1][w:3] \ndeğiştirmek istiyorsan,[w:3] [func:Suprise1]\nşu an burada \nolmamalısın!","[func:NoMercy1]Nasıl çalıştığını \nbiliyorum.[w:6] [func:Think]\nBeni bağışlıyorsun ve \nsonra seni \nöldürüyorum.","[func:NoMercy1]Ve en sonunda \nhiçbir şey \ndeğişmiyor[waitall:4][w:3]...","[func:head4]Bu \ngerçekleşmeyecek,[w:3] [func:Suprise1]\nbunu biliyor musun?","[func:head4]Neden bana umut \nveriyorsun,[w:3] ortak[waitall:4][w:3]?..","[waitall:4][w:3]...[waitall:1][w:3][func:sad]Eğer konuşan \nsen olsaydın,[w:3] tabiki[waitall:4][w:3]...","[func:Look][next] "}
			end
			elseif mercy==4 then
			if lang=="rus" then
...
function FadingChara()
	if lang=="rus" then
		...
		text={"[waitall:4][w:3]...[speed:0.75][w:3]Sonunda özgürsün.[w:6]","Seni ele geçiren o zincirlerden.[w:6]","Geri dönmene izin vermeyen zincirlerden.[w:6]","Bu seni bağışladığım anlamına gelmiyor.[w:6] Sonuçta,[w:3] bu kargaşayı başlatan sensin[waitall:4][w:3]...[waitall:0.75][w:3] [color:ff0000]\nDeğil mi?","Fakat merhamet gösterebilirim.[w:6] \nSen bir insansın.[w:6] \nVe hala türümüzde umut yok[waitall:4][w:3]...[waitall:0.75][w:3]","Fakat asriel bana insanların yok ettikleri kadar da güçlü olmadıklarından bahsetti","İşte bu yüzden onların canavarlarla eşit muamele görmesi lâzım.[w:6] \nOnlara insanlığı öğretmek için,[w:3] onlara arkadaşlığı öğretmek için.[w:6]","Ruhun bir kere daha bu boşluktaki ışık oldu.[w:6]","Çünkü beni dinledin.[w:12] \nAsriel'ı dinledin.[w:6]","Yani[waitall:4][w:3]...[speed:0.75][w:3] \nBizi tekrar pişman etme.[func:Quiet][w:20] \nOrtak.[w:60][next] "}
	end
	for i=1,#text do
	...
	if ingo==1 then
		...
		if PlayerHurtedHimself==0 then
			...
			if lang=="rus" then
				...
				BattleDialog("[func:Shake][func:Sound,hurtsound][func:Sound,hurtsound][color:8040ff]Ahh[w:6] bu vücudu paylaşıyoruz![w:6] \nYani, kendine vurmayı bırak,[w:3] seni aptal![w:6] \nBu sana yardımcı olmaz![w:6]")
				dial={"[func:LostKidFace,shocked,+]Ah?![w:6] \nNeden kendine \nvuruyorsun?!","[func:LostKidFace,shocked2,+][waitall:4][w:3]...[waitall:1][w:3]Acı onu bi süreliğine\nbayılttı mı?","[func:LostKidFace,base_close,-]Tamam[waitall:4][w:3]...[waitall:1][w:3] \nFakat daha saygılı ol.[w:6] [func:LostKidFace,sobbing_thinking,+]\nLütfen.[w:6]"}
			end
			...
			if lang=="rus" then
				...
				BattleDialog({"[func:Shake1][func:Sound,hurtsound][func:Sound,hurtsound][color:8040ff]Çok inatçısın,[w:3] hala beni durdurmak için kendini parçalıyorsun[waitall:4][w:3]...[waitall:1][w:3]","[func:Shake1][func:Sound,hurtsound][func:Sound,hurtsound][color:8040ff]Birkaç parmağın daha kırılırsa testeremi tutamam.[w:6] \nBenimle oynama[waitall:4][w:3]...[waitall:1][w:3]","[func:Shake1][func:Sound,hurtsound][func:Sound,hurtsound][color:8040ff]Dilini ısırırsan umurumda olmaz.[w:6] \nZaten bu konularda kötüyüm.[w:6]","[func:Shake1][func:Sound,hurtsound][func:Sound,hurtsound][color:8040ff]Seni güzelleştirirken çok zaman harcadım,[w:3] tatlım,[w:3] ve şimdi kendini heba mı ediyorsun?![w:6]","[func:Shake1][func:Sound,hurtsound][func:Sound,hurtsound][color:8040ff]İstediğini yap.[w:6] \nFakat birazdan dur.[w:6] \nDaha fazla rezillik istemiyorum.[w:6]","[func:Shake1][func:Sound,hurtsound][func:Sound,hurtsound][color:8040ff]Sen kollarını kırarken Chara'nın ne hissedeceğini düşünmedin mi? Yazık[waitall:4][w:3]...[waitall:1][w:3]"})
				dial=GiveRandom({{"[func:LostKidFace,sobbing_smile,+]Hala sana inanıyorum,[w:3] \nortak[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,sobbing_thinking,+]\nSakın yenilme,[w:3] sana \nyalvarıyorum[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,sobbing_close,-]Yaraların en karanlık \nçukur kadar derin \nolsa da[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,sobbing_smile,+]\nHer zaman yanında \nolacağım.[w:6] \nBana güven.[w:6]"},{"[func:LostKidFace,sobbing_close,-]Biliyorum acıtıyor[waitall:4][w:3]...[waitall:1][w:3] \nFakat,[w:3] yalvarıyorum,[w:3] [func:LostKidFace,sobbing_thinking,+]\ndayan,[w:3] ortak[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,sobbing,+]Az önce işkencen \niyi olabilirdi \nFakat,[w:3] şimdi[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,sobbing_thinking,+]\nBu dehşet verici[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,sobbing_thinking,+]S-senden daha \nkibar olmanı,[w:3] \nistemiştim, değil mi?[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,shocked3,+]Ah[waitall:4][w:3]...[waitall:1][w:3] Bu acıtıyor olmalı[waitall:4][w:3]...[waitall:1][w:3]"}})
			end
		end
		dial[#dial+1]="[noskip][func:LostKidFace,hope_base,+][next] "
		for i=1,#dial do
		...
		if PlayerFlirtCount==1 then
			if lang=="rus" then
				...
				BattleDialog("[color:8040ff]Bir hayalet vücudunu ele geçirirken flört mü ediyorsun?[w:6] \nÇünkü başka bir sebep görmüyorum.[w:6]")
				dial={"[func:LostKidFace,flirt1,+]S[waitall:4][w:3]...[waitall:1][w:3]\nSen ne?[w:6] \nNeden durduk yere \nsaçımı övüyorsun??[w:6] \nBu savaş beynini \nfalan mı eritti???"}
			end
			...
			if lang=="rus" then 
				...
				dial={"[func:LostKidFace,flirt2,-]Bunu boşver![w:6] \nZaten garip \nhissediyorum![w:6] \nOdaklanmam lâzım,[w:3] ve \nbeni bir şekilde \nrahatsız edi[waitall:4][w:3]...[waitall:1][w:3]yor[waitall:4][w:3]...[waitall:1][w:3]!"}
			...
			if lang=="rus" then
				...
				dial={"[func:LostKidFace,flirt3,+]S-Sen bir salaksın,[w:3] \nortak[waitall:4][w:3]...[waitall:1][w:3] \nYalnız değilken bir \nkıza böyle şeyler \nsöylememelisin[waitall:4][w:3]...[waitall:1][w:3]","Fakat istiyorsan[waitall:4][w:3]...[waitall:1][w:3] \nTanrım[waitall:4][w:3]...[waitall:1][w:3] \nSeni sapık."}
			end
			...
			if lang=="rus" then
				...
				dial=GiveRandom({{"[func:LostKidFace,flirt5,+]İyi,[w:3] fakat daha iyisini \nbiliyorum.[w:6] \nİyi bir taht \nolabilirsin.[w:6] \nBenim gibi bir kraliçe \niçin,[w:3] he-he[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,flirt5,+]Tanıdık görünüyorsun,[w:3] \nortak[waitall:4][w:3]...[waitall:1][w:3] \nAh,[w:3] doğru,[w:3] hayatımın \naşkı gibi \ngörünüyorsun,[w:3] he-he[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,flirt5,+]Ortak,[w:3] bir \nmıknatıs gibisin.[w:6] \nSeni uzağa \nitemiyorum,[w:3] he-he[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,flirt5,+]Görüyorum,[w:3] kucağın \nboş gibi.[w:6] \nOturabilir miyim?"},{"[func:LostKidFace,flirt5,+]Hatırlat bana,[w:3] lütfen,[w:3] \nbu akşam boş musun? \nBeni sayma,[w:3] tabiki,[w:3] \nhe-he[waitall:4][w:3]...[waitall:1][w:3]"},{"[func:LostKidFace,flirt5,+]Ortak,[w:3] yorulmuyor \nmusun? \nHer zaman \naklımı çeliyorsun,[w:3] \nhe-he[waitall:4][w:3]...[waitall:1][w:3]"}})
			end
		end
		...
		if PlayerHasItems==5 then
			...
			if lang=="rus" then
				...
				BattleDialog("[color:8040ff]Chara ile bir fincan çay içtin.[w:6] \nSıcak değil mi?[w:6] \nÇok kötü.[w:6]")
				dial={"[func:LostKidFace,1feed1,+][waitall:4][w:3]...[waitall:1][w:3]Bana çay mı vermek \nistiyorsun[waitall:4][w:3]?..[waitall:1][w:3]","Yani[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,1feed2,+]\nŞeyy[waitall:4][w:3]...[waitall:1][w:3]","T-tamam[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,1feed3,+]\n*glüp*[w:6][func:CheckWound][w:6] \nGüzel[waitall:4][w:3]...[waitall:1][w:3]"}
			end
			...
			if lang=="rus" then
				...
				BattleDialog("[color:8040ff]Chara ile bir parça örümcek donatı ısırdın.[w:6] \nÜzücü olarak,[w:3] bir örümcek seni boğmadı.[w:6]")
				dial={"[func:LostKidFace,foodfeed1,+][waitall:4][w:3]...[waitall:1][w:3]A-a-m[w:6][func:CheckWound][w:6] ","[func:LostKidFace,foodfeed2,+]Biliyorsun,[w:3] bu \ndonutlarları \ndüşünürken \nMuffet'ın donutlarını \nyemek zor[waitall:4][w:3]...[waitall:1][w:3] \nFakat sorun yok.[w:6]"}
			end
			...
			if lang=="rus" then
				...
				BattleDialog("[color:8040ff]Chara'yı lazanya.[w:6] \nBekle,[w:3] o bir Tamagotchi mi,[w:3] bir ihtimal?")
				dial={"[func:LostKidFace,foodfeed1,+][waitall:4][w:3]...[waitall:1][w:3] *Şlürp*[w:6][func:CheckWound][w:6] ","[func:LostKidFace,foodfeed2,+]Papyrus'un \nmakarnası[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,sobbing_close,-]\nŞey gibi hissettirdi[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,sobbing_smile_close2,-]\nEve geri dönmüşüm \ngibi[waitall:4][w:3]...[waitall:1][w:3] \nMmm.[w:6]"}
			end
			...
			if lang=="rus" then
				...
				BattleDialog({"[color:8040ff]Chara'yı kutsal su ile besledin[waitall:4][w:3]...[w:6]\n...[waitall:1][w:3]Bu tuhaftı.[w:6]","[color:8040ff][w:3]Başka bir yiyeceğim kalmadı.[w:6]\nSana tavsiyem ona biraz kardan adam parçası ver.[w:6]"})
				dial={"[func:LostKidFace,drinkfeed1,+][waitall:4][w:3]...[waitall:1][w:3]*glüp*[w:6][func:CheckWound][w:6] ","[func:LostKidFace,drinkfeed2,+]Off[waitall:4][w:3]...[waitall:1][w:3] \nBunun ne kadar \ngarip hissettirdiğini \nsöyleyemem[waitall:4][w:3]...[waitall:1][w:3]"}
			end
			...
			if diff>1 then
				if lang=="rus" then
					...
					BattleDialog({"[color:8040ff][noskip]Ona bir kardan adam parçası verdin.[w:6]\nVay[waitall:4][w:3]...[waitall:1][w:3] \nEtkilendim","[color:8040ff][noskip]Yiyeceğin kalmadı.[w:6] \nVe hiçlikten bir turta çıkmayacak,[w:3] bahse girebilirim.[w:6]"})
					dial={"[func:LostKidFace,snowfeed1,+][waitall:4][w:3]...[waitall:1][w:3]А-а-m","[func:LostKidFace,snowfeed2,+]!!!","[func:LostKidFace,snowfeed4,+]N-ne?[w:6]![w:6].[w:6].[w:6] \nOrtak,[w:3] bu bir şa-[func:LostKidFace,snowfeed3,+][func:CheckWound][w:6] \nAh[waitall:4][w:3]...[waitall:1][w:3] \nCidden iyileştirdi[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,snowfeed4,+]Fakat bu \nyapışkan beyaz[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,snowfeed5,+]\nKarı[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,snowfeed3,+]\nNasıl [waitall:4][w:3]temizleyeceğim[waitall:1][w:3]"}
				end
				elseif diff==1 then
				if lang=="rus" then
					dial={"[func:LostKidFace,snowfeed1,+][waitall:4][w:3]...[waitall:1][w:3]А-а-ам","[func:LostKidFace,snowfeed2,+] !!!","[func:LostKidFace,snowfeed4,+]К-какого?[w:6]![w:6].[w:6].[w:6] Партнёр,[w:3] \nты издева-[func:LostKidFace,snowfeed3,+][func:CheckWound][w:6]  \nО[waitall:4][w:3]...[waitall:1][w:3] Оно всё-таки \nлечит[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,snowfeed4,+]Но как мне стереть \nэту белую[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,snowfeed5,+] \nмокрую[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,snowfeed3,+]снег[waitall:4][w:3]?..[waitall:1][w:3]"}
					...
					dial={"[func:LostKidFace,snowfeed1,+][waitall:4][w:3]...[waitall:1][w:3]А-а-m","[func:LostKidFace,snowfeed2,+]!!!","[func:LostKidFace,snowfeed4,+]N-ne?[w:6]![w:6].[w:6].[w:6] \nOrtak,[w:3] bu bir şa-[func:LostKidFace,snowfeed3,+][func:CheckWound][w:6] \nAh[waitall:4][w:3]...[waitall:1][w:3] \nCidden iyileştirdi[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,snowfeed4,+]Fakat bu yapışkan \nbeyaz[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,snowfeed5,+]\nKarı[waitall:4][w:3]...[waitall:1][w:3]\nNasıl[func:LostKidFace,snowfeed3,+] [waitall:4][w:3]temizleyeceğim[waitall:1][w:3]"}
				end
			end
			PlayerHasItems=0
			...
			if diff==1 then
				if lang=="rus" then
					...
					dial={"[func:LostKidFace,foodfeed1,+][waitall:4][w:3]...[waitall:1][w:3]*ham*[w:6][func:CheckWound][w:6] ","[func:LostKidFace,foodfeed2,+]Asriel cidden \nbu turtaları \nannemden mi gizledi[waitall:4][w:3]?..[waitall:1][w:3]","[func:LostKidFace,flirt3,+]Hayır ise,[w:3] neden \nburada bu kadar çok \nolduğunu anlamadım[waitall:4][w:3]...[waitall:1][w:3]"}
				end
				if enemies[1].GetVar("hp")<1500 then
					enemies[1].SetVar("hp",enemies[1].GetVar("hp")+360)
				end
		...
		if SparedFirstTime==0 then
			...
			if lang=="rus" then
				...
				dial=GiveRandom({{"[func:LostKidFace,hope_cheers,+]Lütfen,[w:3] azimli kal![w:6] [func:LostKidFace,hope_smile,+]\nOnun tekrar seni ele \ngeçirmesine izin \nverme![w:6]"},{"[func:LostKidFace,hope_close,-]Epey ilerledik[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,hope_cheers,+]\nBeraber.[w:6] [func:LostKidFace,hope_smile,+]\nBeni sakın bırakma,[w:3] \nortak![w:6]"},{"[func:LostKidFace,hope_smile,+]Seni sonunda \nanlıyorum[waitall:4][w:3]...[waitall:1][w:3][func:LostKidFace,hope_sobbing,+]\nSeni tekrar \nkaybedemem![w:6]"},{"[func:LostKidFace,hope_close,-]Hatırla[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,hope_cheers,+]\nSeni destekliyoruz![w:6] [func:LostKidFace,hope_sobbing,+]\nYalnız değilsin![w:6]"}})
				BattleDialog(GiveRandom({"[color:8040ff]Ne kadar sıra atlarsan,[w:3] işim o kadar kolaylaşır.","[color:8040ff]Kendini kurtaramazsan başkasını kurtarmazsın.","[color:8040ff]İlginç,[w:3] merhamet artık tek çıkış yolumuz,[w:3] değil mi?","[color:8040ff]Dayanmayı bırak - bunu ikimiz için de kolaylaştır.[w:6]","[color:8040ff]Seni alt edince,[w:3] sırada o olacak.[w:6] Sakın umutlanma.[w:6]","[color:8040ff]Merhametin beni sana yönlendirdi.[w:6] \nNeden şimdi fikrini değiştiriyorsun?"}))
			end
			else
			if lang=="rus" then
...
function Differ(ingo)
	...
	if ingo==1 then
		...
		if lang=="rus" then
			...
			outgo="[color:ff0000]Anasını bile siker"
		end
	end
	return outgo
end
...
function ReadyGlobalSave(ingo)
	...
	if ingo=="1" then
		...
		if lang=="rus" then
			...
			dial={" [next] ","[effect:none]Kısaca,[w:3] seninle \nkonuşurken o [w:7][w:3]atak \ndenilen mantıksız \nşeylerden \nkaçacaksın.","[func:Achivement][func:SetMusic,lost][next] "}
		end
		if Achivements[4]=="0" then
		...
		if lang=="rus" then
			...
			comm="İşler ilginç olmaya başladı.[w:6]\nAcele etmeyelim,[w:3] tatlım.[w:6] konuşmasına izin ver."
		end
		SetGlobal("facial_expression",60)
	end
	local command={}
...
function LostHadLost()
	...
	if lang=="rus" then
		...
		dial={"[func:Music,finale][func:LostKidFace,base_close,-]A[waitall:4][w:3]...[waitall:1][w:3] \nAh[waitall:4][w:3]...[waitall:1][w:3] \nAcıttı mı[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,hope_base,+]Umarım bu çok fazla \nacıtmamıştır[waitall:4][w:3]...[waitall:1][w:3] \nAcı verici[waitall:4][w:3]...[waitall:1][w:3] [func:LostKidFace,hope_smile,+]\nKendimi tekrarladığım \niçin kusuruma bakma[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,hope_sobbing,+]Dürüst olmak \ngerekirse[waitall:4][w:3]...[waitall:1][w:3] \nGöğsümdeki yara \nkadar acıtmıyor.","[func:LostKidFace,sobbing_smile,+]Çünkü bu duygu[waitall:4][w:3]...[waitall:1][w:3] \nBu ikimiz içinde son,[w:3] \nortak[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,hope_cheers,+]Bizi koruyamadım[waitall:4][w:3]...[waitall:1][w:3] \nBu senin hatan değil.[w:6]","[func:LostKidFace,hope_sobbing,+]Suçlanması gereken \ntek kişi[waitall:4][w:3]...[waitall:1][w:3] \nBenim.","[func:LostKidFace,hope_cheers,+]Eğer ahiret gerçek \nise[waitall:4][w:3]...[waitall:1][w:3] \nUmarım orada da[waitall:4][w:3]...[waitall:1][w:3] Karşılaşırız[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,hope_deathsmile,+][func:QuietMusic]Hele şükür[waitall:4][w:3]...[waitall:1][w:3] [waitall:1][w:3] [func:LostKidFace,hope_deathsmile_close2,-]\nArkadaşım[waitall:4][w:3]...[waitall:1][w:3][func:dead][w:60][func:LostHasLost]"}
	end
	for i=1,#dial do
		dial[i]="[noskip]"..dial[i]
	end
...
function Gotcha()
		...
		if lang=="rus" then
			...
			enemies[1].SetVar("currentdialogue", {"[noskip][func:head4]Ve.[w:4].[w:4].[w:4] [func:NoMercy1]\nYakaladım!"})
		end
		nextwaves = {"nothing"}
		State("ENEMYDIALOGUE")
end
...
function HappyCharaMeal1()
	...
	if lang=="rus" then
		...
		dial={"[func:LostKidFace,hope_question,+]Yani[waitall:4][w:3]...[waitall:1][w:3] \nBitti mi?","[func:HappyCharaMeal2]"}
	end
	for i=1,#dial do
...
function HappyCharaMeal3()
	...
	if lang=="rus" then
		...
		local part={}
		if hp==1500 then
			part[1]="[func:LostKidFace,chocolate1,+]Tüm bu olanlardan \nsonra kafamı \ntoplamalıyım."
		end
		if hp<1200 then
			part[#part+1]="[func:LostKidFace,chocolate1,+]Çikolata her yaraya \niyi gelir.[w:6]"
		end
		if hp<800 then
			part[#part+1]="Bütün gün \nyiyebilirdim[waitall:4][w:3]...[waitall:1][w:3]"
		end
		if hp<450 then
			part[#part+1]="Ama yediğim en iyi \nçikolata babamınki[waitall:4][w:3]...[waitall:1][w:3]"
		end
		if hp<150 then
			part[#part+1]="[func:LostKidFace,chocolate4,+]İnanılmaz.[w:6] \nYeni gibi hissediyorum.[w:6]"
		end
		dial={"[func:LostKidFace,hope_smile,+][func:KnifeInPocket]Bir dakika,[w:3] ortak[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,chocolate1,+][func:TakeOutChocolate]Tüm bu yorucu \ngünden sonra bir \nyenileyiciye \nihtiyacım var[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,chocolate2,+][func:EatChocolate1][waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,chocolate3,-][func:EatChocolate2][waitall:4][w:3]...[waitall:1][w:3]Mmm,[w:3] çikolatayı \nseverim.[w:6]"}
		for i=1,#part do
			dial[#dial+1]=part[i]
		end
		dial[#dial+1]="[func:HappyCharaMeal4]"
...
function HappyCharaMeal5()
	...
	if lang=="rus" then
		...
		dial={"[func:LostKidFace,chocolate3,-][func:BackChocolate]Ah,[w:3] hemen değil,[w:3] \nortak","Önce sen.[w:6] [func:GiveChocolate]\nHadi ama,[w:3] bir ısırık al.[w:6]","[func:HappyCharaMeal6]"}
	end
	for i=1,#dial do
		dial[i]="[noskip][effect:none]"..dial[i]
	end
...
function HappyCharaMeal7()
	...
	if lang=="rus" then
		...
		dial={"[func:LostKidFace,chocolate1,+]Ahhh,[w:3] hayır~","Yakınlaş.[w:6] \n[func:LostKidFace,chocolate2,+]Ağzını aç~","[func:HappyCharaMeal8]"}
	end
	for i=1,#dial do
		dial[i]="[noskip][effect:none]"..dial[i]
	end
...
function HappyCharaMeal9()
	...
	if lang=="rus" then
		...
		dial={"[func:LostKidFace,hope_cheers,+][func:BackChocolate]Peki.[w:6].[w:6] \nMaceranı bitirme \nzamanı geldi,[w:3] \ndeğil mi?","[func:LostKidFace,hope_close,-]Dürüst olmak \ngerekirse,[w:3] yeniden \nbirleşecek pasifist \nzaman çizelgemizi \nbekliyordum,[w:3] \nama çok yakında?[waitall:4][w:3]...[waitall:1][w:3]","[func:LostKidFace,hope_base,+]Gerçekten mutlu \nolacağım.[w:6]","[func:LostKidFace,hope_sobbing,+][func:NoChocolate]Hadi ama.[w:6] \nYapacak işlerimiz var.[w:6]","[func:HappyCharaMeal10]"}
	end
	for i=1,#dial do
		dial[i]="[noskip][effect:none]"..dial[i]
	end
...
function HappyCharaMeal11()
	...
	if lang=="rus" then
		...
		dial={"[func:CharaDownFaces,hope_base]* Peki,[w:3] ortak[waitall:4][w:3]...[waitall:1][w:3] \nBu bizim ayrılış noktamız","[func:CharaDownFaces,hope_cheers]* Ama yakında seninle yeniden buluşacağım.[w:6] \nPeki[waitall:4][w:3]...[waitall:1][w:3] \nGeçmişteki ben ile.[w:6]","[func:CharaDownFaces,hope_close]* Seni kurtarabilen[waitall:4][w:3]...[waitall:1][w:3] \nChara olmaktan mutluyum","[func:CharaDownFaces,hope_smile]* Otağını kurtar","[func:HideCharaDownFace][func:HappyCharaMeal12]"}
	end
	for i=1,#dial do
...
function HappyCharaMeal12()
	...
	if lang=="rus" then
		...
		dial={"Sakarca dönüyorsun.[w:6]","Sonuçta,[w:3] göz yaşların yanaklarından damlıyor[waitall:4][w:3]...[waitall:1][w:3]","İşte,[w:3] işte[waitall:4][w:3]...[waitall:1][w:3] \nAğlamanın hiç sırası değil şu an","[func:HappyCharaMeal13][color:000000]"}
	end
	for i=1,#dial do
		dial[i]="[noskip][novoice][voice:uidial]"..dial[i]
	end
...
function ENOUGH()
	...
	if lang=="rus" then
		...
		comm=comm.."Sana yalvarıyorum, YETER!"
	end
	encountertext=comm
	State("ACTIONSELECT")
end
...
function TryThis()
	...
	if lang=="rus" then
		...
		dial=dial.."Biliyorsun,[w:3] bu biraz sıkıcı.[w:6]\nHadi bir şeyi değiştirelim.[w:6]\nÖrneğin[waitall:4][w:3]..."
	end
